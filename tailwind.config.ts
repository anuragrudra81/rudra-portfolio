  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'pulse-slow': { '0%, 100%': { opacity: '1', transform: 'scale(1)' }, '50%': { opacity: '0.7', transform: 'scale(1.05)' } },
        'pulse-slower': { '0%, 100%': { opacity: '0.8', transform: 'scale(1)' }, '50%': { opacity: '0.5', transform: 'scale(1.1)' } },
      },
      animation: {
